...
dns_forwarding_ruleset_name = "h-eus2-ruleset-forwarding"
outbound_endpoint_id        = "/subscriptions/8cc21a98-4584-4bed-8643-4cb6fd0d7bbf/resourceGroups/h-eus2-rg-privatednsresolver/providers/Microsoft.Network/dnsResolvers/h-eus2-dnspr-dns01/outboundEndpoints/h-eus2-ep-dns01out"
...
tags = {
  ...
  DisplayName   = "Private DNS Resolver Ruleset"
...
dns_forwarding_rules = {
  "apijewelersmutualcom" = {
    ...
    target_dns_servers = ["10.121.0.70:53", "10.121.0.69:53"]
  },
...
vnets = {
  vnet1 = "/subscriptions/8cc21a98-4584-4bed-8643-4cb6fd0d7bbf/resourceGroups/h-eus2-rg-hub/providers/Microsoft.Network/virtualNetworks/h-eus2-vnet-hub"
