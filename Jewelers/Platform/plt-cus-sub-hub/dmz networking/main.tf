...
resource "azurerm_virtual_network_peering" "hub_to_dmz" {
  ...
  name                         = "hub_vnet_to_dmz_vnet"
  resource_group_name          = data.azurerm_resource_group.hub_rg.name
  virtual_network_name         = data.azurerm_virtual_network.hub_vnet.name
  remote_virtual_network_id    = module.vnet["h-cus-vnet-dmz"].id
...
resource "azurerm_virtual_network_peering" "dmz_to_hub" {
  name                         = "dmz_vnet_to_hub_vnet"
  resource_group_name          = var.rg_name
  virtual_network_name         = module.vnet["h-cus-vnet-dmz"].vnet_name
