...
subscription_id = "376456a3-203b-4ed9-ab97-f677d2df8a07"
...
tags = {
  ...
  Department    = "IT"
  Description   = "Sandbox SQL"
  DisplayName   = "Sandbox SQL"
  Environment   = "Sandbox"
  Tier          = "00"
}
...
vnets = [ ##update
  {
    resource_group = "x-cus-rg-sql"
    name           = "x-cus-vnet-sql"
    cidr           = ["10.130.128.0/21"]
    dns_servers    = []
  }
]
