...
resource "azurerm_virtual_network_peering" "hub_to_identity" {
  ...
  remote_virtual_network_id    = module.vnet["p-cus-vnet-sql"].id ##update format "i-cus-vnet-identity"
...
resource "azurerm_virtual_network_peering" "identity_to_hub" {
  ...
  virtual_network_name         = module.vnet["p-cus-vnet-sql"].vnet_name ##update format "i-cus-vnet-identity"
