...
#################################################################
#################################################################
##c40b7c30-c824-4db0-aaa8-eef5dbd10f3a
subscription_id = "c40b7c30-c824-4db0-aaa8-eef5dbd10f3a"
...
tags = {
  ...
  Department    = "IT"
  Description   = "DR Training"
  DisplayName   = "DR Training"
  Environment   = "DR Production Training"
  Tier          = "1"
}
...
vnets = [ ##update
  {
    resource_group = "p-eus2-rg-training"
    name           = "p-eus2-vnet-training"
    cidr           = ["10.121.96.0/19"]
    dns_servers    = []
  }
]
...
subnet = { ##update
  p-eus2-snet-servers = {
    subnet_range                                   = ["10.121.96.0/22"]
    service_endpoints                              = []
    delegation_name                                = null
    delegation_actions                             = null
    enforce_private_link_endpoint_network_policies = true
    vnet                                           = "p-eus2-vnet-training"
    nsg                                            = "p-eus2-nsg-servers"
    route_table                                    = true
  },
  p-eus2-snet-sql = {
    subnet_range                                   = ["10.121.100.0/23"]
    service_endpoints                              = []
    delegation_name                                = null
    delegation_actions                             = null
    enforce_private_link_endpoint_network_policies = true
...
route_tables = [
  {
    ...
    vnet                          = "p-eus2-vnet-training" #update
...
key_vault_name = "p-eus2-kv-training01" ###"ieus2identitykv" ##update
